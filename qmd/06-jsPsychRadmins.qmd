...
# Adapts the Dockerfile_TEMPLATE to the pid of the project
create_dockerfile(PID = 999)

# Builds the docker container (ONLY ONCE)
system("docker build -t project .")

# Runs the analysis (the user should be able to do this)
...
# The outputs folder will be recreated in ~/Downloads/jsPsychHelpeR/ after a couple minutes
