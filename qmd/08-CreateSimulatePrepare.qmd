...
-   Change parameter `local_folder_tasks` to your folder_output above. For example `local_folder_tasks = "~/Downloads/protocol999"`
...
#### 5) Tidy output data {.unnumbered}

Move the monkeys responses csv's (should be in your `Downloads` folder) to the protocol folder. For example, ~/Downloads/protocol999/data
