...
The monkeys responses csv's should be initially downloaded in your `Downloads` folder, and thn moved to a `.data/` folder inside the protocol folder. For example, `~/Downloads/protocol999/.data`
