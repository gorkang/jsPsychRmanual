...
The function `create_docker_container()` will create a fully reproducible docker container with the data preparation and analysis for a specific project.  
...
The funcion `create_DF_analysis()` has the parameter `DVars` to select the Dependent Variables in your data that should be scrambled to be ready for a blinded analysis. 
