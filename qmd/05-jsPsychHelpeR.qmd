...
The funcion `create_DF_analysis()` haste parameter `DVars` to select the Dependent Variables in your data that should be scrambled to be ready for a blinded analysis. 
