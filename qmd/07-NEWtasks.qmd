...
# Launch this two commands in the new RStudio project (gorkang-jsPsychMaker-...)
invisible(lapply(list.files("./R", full.names = TRUE, pattern = ".R$"), source)) # Source functions
