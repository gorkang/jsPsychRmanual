...
To replicate an experimental protocol from a publication is not trivial. One of the main goals of this system is to be able to create, share and reproduce an experiment, its data, and data preparation and analysis without any extra effort.
