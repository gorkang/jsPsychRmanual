...
In June 2022 we have more than 60 tasks implemented. The full details about the available tasks can be checked in [this document](https://docs.google.com/spreadsheets/d/1Eo0F4GcmqWZ1cghTpQlA4aHsc8kTABss-HAeimE2IqA/edit#gid=0). 

We are in the process of filling all the tasks details to the document, but in the meantime, you can check [the full list of tasks in the Github repo](https://github.com/gorkang/jsPsychMaker/tree/main/canonical_protocol/tasks).

If you need help implementing a NEW task [fill this form](https://docs.google.com/spreadsheets/d/1LAsyTZ2ZRP_xLiUBkqmawwnKWgy8OCwq4mmWrrc_rpQ/edit#gid=0).   
...
There is a shiny app in `jsPsychMaker/app/` to edit the main parameters of the `config.js` using a visual interface.  
