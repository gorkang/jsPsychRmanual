...
## jsPsychMaker: How to create an experimental protocol {#QuickGuidejsPsychMaker}
...
3) Open `index.html` in your folder
...
The variable `not_ordered_experiments` should contain only the tasks we want to run. See a [list of tasks](https://github.com/gorkang/jsPsychMaker/blob/main/canonical_protocol/canonical_protocol_details.csv) available in the repo.  
...
- Download results files for the project `only on Ubuntu`
