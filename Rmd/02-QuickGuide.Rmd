...
The variable `tasks` should contain the name of an array of the tasks we want to run. See a [list of tasks](https://github.com/gorkang/jsPsychMaker/blob/main/canonical_protocol/canonical_protocol_details.csv) available in the repo.  
