...
All the output processed dataframes columns are named in a standardized way:  
...
All the `prepare_NAMEOFTASK.R` scripts on the `R_tasks/` folder have been created starting from the same template. The experimental tasks and some surveys have particularities that require more complex adaptations.    
